...
kube::build::get_docker_wrapped_binaries() {
  ...
  local targets=(
    cloud-controller-manager,"registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-${arch}:${debian_base_version}"
    kube-apiserver,"registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-${arch}:${debian_base_version}"
    kube-controller-manager,"registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-${arch}:${debian_base_version}"
    kube-scheduler,"registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-${arch}:${debian_base_version}"
    kube-proxy,"registry.cn-hangzhou.aliyuncs.com/google_containers/debian-iptables-${arch}:${debian_iptables_version}"
  )
...
# $3 is the value to set the  flag for docker build; true by default
