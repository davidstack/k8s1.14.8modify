### registry.cn-hangzhou.aliyuncs.com/google_containers/etcd docker image
...
Each `registry.cn-hangzhou.aliyuncs.com/google_containers/etcd` docker image is tagged with an version string of the form
...
In addition to the latest etcd version, each `registry.cn-hangzhou.aliyuncs.com/google_containers/etcd` image contains
...
`registry.cn-hangzhou.aliyuncs.com/google_containers/etcd` images the default umask is 0022 which will result in 0755
